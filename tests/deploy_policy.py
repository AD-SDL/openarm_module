...
POLICY_PATH = (
    Path.home()
    / "/home/rpl/humanoids/openarm_module/outputs/train/openarm_open_lab_door_v1/checkpoints/100000/pretrained_model"
)
    ...
    try:
        ...
        while True:
            ...
            batch = {
                ...
                .unsqueeze(0)
                .to(device),
                "observation.images.left_chest": torch.from_numpy(chest_image)
                .permute(2, 0, 1)
                .unsqueeze(0)
                .to(device),
                "observation.images.left_wrist_left": torch.from_numpy(wrist_left_image)
                .permute(2, 0, 1)
                .unsqueeze(0)
                .to(device),
                "observation.images.right_wrist_right": torch.from_numpy(
                    wrist_right_image
                )
                .permute(2, 0, 1)
                .unsqueeze(0)
